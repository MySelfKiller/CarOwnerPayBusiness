...
class FileUtil private constructor() {
    ...
    companion object {
        ...
        const val DIR = ".AndroidQuick"
        val CUSPATH =
            Environment.getExternalStorageDirectory().path + File.separator + DIR + File.separator
        ...
        fun assetsDataToSD(context: Context, assetsDataName: String?, fileName: String) {
            ...
            val myOutput: OutputStream = FileOutputStream(fileName)
        ...
        fun insertCardRerousce(sourcefile: String?, targetfile: String?) {
        ...
        fun writeFile(filePath: String, content: String?, append: Boolean = false): Boolean {
            ...
            return try {
                ...
                IOUtil.Companion.close(fileWriter)
            }
        }
        /**
         * write file
        ...
        fun writeFile(file: File?, stream: InputStream, append: Boolean = false): Boolean {
            ...
            return try {
                ...
                IOUtil.Companion.close(o)
                IOUtil.Companion.close(stream)
            }
        }
        ...
        fun copyFile(sourceFilePath: String?, destFilePath: String?): Boolean? {
            ...
            return inputStream?.let { writeFile(destFilePath, it) }
        }
        ...
        fun checkFileSize(filepath: String?, maxSize: Int): Boolean {
            ...
            return if (file.length() <= maxSize * 1024) {
                true
            } else {
                false
            }
