...
class CategoryRootAdapter     //        this.mContext = mContent;
//        this.flag = flag;
    (
    var dataList: MutableList<MutableList<CategoryBean>>?,
    private val itemCallback: ItemCallback?
) : RecyclerView.Adapter<CategoryRootAdapter.MyViewHolder>() {
    private var mContext: Context? = null
    fun addAllData(dataList: List<MutableList<CategoryBean>>?) {
...
//        KWApplication.getInstance().loadImg(dataList.get(position).icon,holder.tv_img);
        ...
        val categoryAdapter = CategoryAdapter(dataList!![position], object : ItemCallback {
